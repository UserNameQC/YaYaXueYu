...
////
//package com.runto.controler.views;
...
//
//import static android.support.v4.view.WindowInsetsCompat.wrap;
//
...
//                return onApplyWindowInsets(v, ViewCompat.onApplyWindowInsets(v, wrap(insets)));
//            }
//
//            private final Rect mTempRect = new Rect();
//
...
//                    int i = 0;
//
//                    for(int count = ViewPager.this.getChildCount(); i < count; ++i) {
...
//                    for(ii = (ViewPager.ItemInfo)this.mItems.get(itemIndex); pos > ii.position && itemIndex < this.mItems.size() - 1; ii = (ViewPager.ItemInfo)this.mItems.get(itemIndex)) {
//                        ++itemIndex;
//                    }
//
...
//                    for(ii = (ViewPager.ItemInfo)this.mItems.get(itemIndex); pos < ii.position && itemIndex > 0; ii = (ViewPager.ItemInfo)this.mItems.get(itemIndex)) {
//                        --itemIndex;
//                    }
//
//                    while(pos > ii.position) {
...
//            for(ii = (ViewPager.ItemInfo)this.mItems.get(i); pos > ii.position; offset -= this.mAdapter.getPageWidth(pos--) + marginOffset) {
//                ;
//            }
//
//            offset -= ii.widthFactor + marginOffset;
...
//            }
//
//            public ViewPager.SavedState createFromParcel(Parcel in) {
//                return new ViewPager.SavedState(in, (ClassLoader)null);
//            }
//
